...
public class CA3_poisson {
	...
	int size = 500; //8*spacing+1; // Size of the system lattice
    ...
    int dataWriteStep = 20005; // how often we write down the data
    int dataReportStep = 10; // how often we print the data
...
//		for (int i=0;i<o2perTS;i++) iterateOxygen();  // oh dear
		...
		// 		System.out.println (+mutationNum+", "+stem_cells_this_TS+", "+non_stem_cells_this_TS+", "+timestep); // print (parent,child) pair
		// 		}
		timestep++;
