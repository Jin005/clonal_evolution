...
public class Vis3 extends JApplet implements ActionListener{
	...
	int mag = 2; // Magnification factor (WAS 2)
        int imageWriteStep = 250; // how often we save the image file
	public CA3 ca;
	...
	public static void main(String args[]) {
		...
		JFrame f = new JFrame("CSCTherapy CA Visualisation "+CA3.version); //dunno why i had to change CA to CA3
